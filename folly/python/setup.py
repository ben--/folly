#/tmp/fbcode_builder_getdeps-ZUsersZbenZossZsaplingZbuildZfbcode_builder-root/build/eden/eden/integration/hg/hg_integration_tests.egg/folly/iobuf.py!/usr/bin/env python3
